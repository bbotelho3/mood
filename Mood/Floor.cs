...
namespace Mood
{
    public class Floor : WorldObject
    {
        ...
        public Floor(Point3d a, Point3d b, Point3d c, Point3d d)
        {
            A = a;
            B = b;
            C = c;
        ...
        public Floor(Point3d a, Point3d b, Point3d c, Point3d d, Color color)
            : this(a, b, c, d)
        {
            this.color = color;
        }

        public Floor(Point3d a, Point3d b, Point3d c, Point3d d, Texture texture)
            : this(a, b, c, d)
        {
